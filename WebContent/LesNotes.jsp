          ...
          <div class="col-md-4 col-md-offset-3">
            <form action="" class="search-form">
             ...
             <table class="table table-hover" id="myTable">
                    <jsp:useBean id="daoEtudie" class="AccesBD.DAOEtudie"/>
                    ...
                    <c:forEach items="${FinaleListeNote}" var="note"> 
                    <tbody>
                        <tr>
                                  <td><c:out value="${note.getNom_etudiant()}"></c:out><br></td>
                                  <td><c:out value="${note.getPrenom_etudiant()}"></c:out><br></td>
                                  <td><c:out value="${note.getNote()}"></c:out><br></td>
                        </tr>
                     </tbody>
                     </c:forEach>
                </table>
