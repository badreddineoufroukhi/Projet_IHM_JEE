        ...
        <section>
          <div>
           ...
           <table class="table table-striped" id="myTable" data-filter-control="True"
                   ...
                   <c:forEach items="${daoEnseigne.selectElemParProf(prof)}" var="elem">
                      <tbody>
                        <tr id="data" >
                            <td>
                            <form action="ControleurElementNote" method="post" class="container">
                             <input name="inputliste1" value="${elem}" readonly>
                            </td>
                            <td >
                             <input type="submit" value="chooser" class="btn btn-success"/>
                            </form>
                            </td>
                        </tr>
                        </tbody>
