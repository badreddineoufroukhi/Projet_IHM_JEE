    ...
    <nav class="navbar navbar-dark  navbar-fixed-top">
      <div class="container-fluid">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#menu-toggle" id="menu-toggle"> <span class="glyphicon glyphicon-menu-hamburger"
              aria-hidden="true"></span> <span class="logo">JEE</span>
          </a>
        </div>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-user"
                  aria-hidden="true"></span> Administrator <span class="caret"></span></a>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      <c:forEach items="${listElems}" var="elem">
                        <tr>
                          <td>
                            <form action="ControleurAffectation" method="post" class="container">
                              <input name="inputliste2" value="${elem.getNomElem()}" readonly />
                              <br><br>
                              <c:if test="${empty mssg}">
                                <div class="row">
                                  ...
                                  <input type="submit" value="Affecter" class="btn btn-success" />
                                </div>
                              </c:if>
